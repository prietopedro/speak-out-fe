...
function StudentRegistrationForm({ handleCancelButtonOnForm }) {
  ...
  function handleChange(event) {
    if (
      event.target.name === "noCall" ||
      event.target.name === "delinquent" ||
      event.target.name === "expelled"
    ) {
        ...
        >
          ...
          <div style={{ gridColumn: "span 2", display: "flex" }}>
            <div style={{ marginRight: "30px" }}>
              <label>No call</label>
              <div>
                <Input type="checkbox" name="noCall" onChange={handleChange} />
              </div>
            </div>
            <div style={{ marginRight: "30px" }}>
